...
def main(n_parallel=1, budget=1, seq_length=1, n_rl_itr=1, n_cont_samples=10,
         seed=0, log_dir=None, snapshot_mode='gap', snapshot_gap=500):
    ...
    sac_ces(n_parallel=n_parallel, budget=budget, seq_length=seq_length,
            n_rl_itr=n_rl_itr, n_cont_samples=n_cont_samples, seed=seed)
...
if __name__ == "__main__":
    ...
    exp_id = args.id
    main(n_parallel=args.n_parallel, budget=args.budget,
